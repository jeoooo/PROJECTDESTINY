...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("2g1dretq")

  // remove
  collection.schema.removeField("khwq6kjn")

  // remove
  collection.schema.removeField("gofxibib")

  // remove
  collection.schema.removeField("qxutlxrc")
