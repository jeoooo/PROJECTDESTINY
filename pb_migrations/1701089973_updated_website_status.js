...
migrate((db) => {
  ...
  collection.createRule = "@collection.api_keys.api_key ?= @request.headers.authorization"
  collection.updateRule = "@collection.api_keys.api_key ?= @request.headers.authorization"
