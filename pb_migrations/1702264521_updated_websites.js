...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("cmwp2tue")

  // remove
  collection.schema.removeField("0f0xue7h")

  // remove
  collection.schema.removeField("drxgyktd")

  // remove
  collection.schema.removeField("nmerbfe3")

  // remove
  collection.schema.removeField("v9n9dony")
