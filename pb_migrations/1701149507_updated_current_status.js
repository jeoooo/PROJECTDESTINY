...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("uqizh2s3")

  // remove
  collection.schema.removeField("bh78zvbk")

  // remove
  collection.schema.removeField("bnsgcshk")

  // remove
  collection.schema.removeField("zrdxfne8")
